module.exports = {
  ...
  MISSING_BLOB_API: 'advanced-http: Blob API is not supported in this webview. If you want to use "multipart/form-data" requests, you need to load a polyfill library before loading this plugin. Check out https://github.com/carlossilveira-commonms/cordova-plugin-advanced-http-x509/wiki/Web-APIs-required-for-Multipart-requests for more info.',

...
This feature depends on several Web APIs. See https://github.com/carlossilveira-commonms/cordova-plugin-advanced-http-x509/wiki/Web-APIs-required-for-Multipart-requests for more info.

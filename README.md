...
=====================
[![npm version](https://img.shields.io/npm/v/cordova-plugin-advanced-http-x509)](https://www.npmjs.com/package/cordova-plugin-advanced-http-x509?activeTab=versions)
[![MIT Licence](https://img.shields.io/badge/license-MIT-blue?style=flat)](https://opensource.org/licenses/mit-license.php)
[![downloads/month](https://img.shields.io/npm/dm/cordova-plugin-advanced-http-x509.svg)](https://www.npmjs.com/package/cordova-plugin-advanced-http-x509)

[![Travis Build Status](https://img.shields.io/travis/com/silkimen/cordova-plugin-advanced-http-x509/master?label=Travis%20CI)](https://app.travis-ci.com/silkimen/cordova-plugin-advanced-http-x509)
[![GitHub Build Status](https://img.shields.io/github/actions/workflow/status/silkimen/cordova-plugin-advanced-http-x509/.github/workflows/ci.yml?branch=master)](https://github.com/carlossilveira-commonms/cordova-plugin-advanced-http-x509/actions)
...
```shell
phonegap plugin add cordova-plugin-advanced-http-x509

cordova plugin add cordova-plugin-advanced-http-x509
```
...
:warning: `multipart` depends on several Web API standards which need to be supported in your web view. Check out https://github.com/carlossilveira-commonms/cordova-plugin-advanced-http-x509/wiki/Web-APIs-required-for-Multipart-requests for more info.
